...
<div
    ...
    x-show="open"
    x-transition
    class="min-w-[300px] fixed top-5 right-5 flex justify-between rounded-lg bg-white border border-green-500 overflow-hidden">

    {{-- Validation Message --}}
    <div class="flex items-center">
        <div class="px-3 py-3 gird place-items-center bg-green-500">
        ...
        <div class="px-5 py-3">
            <p class="font-poppins text-sm text-green-500">{{ $message }}</p>
        </div>
    </div>
